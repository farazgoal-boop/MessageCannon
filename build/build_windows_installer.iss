; Inno Setup script for MessageCannon Pro
#define MyAppName "MessageCannon Pro"
#define MyAppVersion "1.0.0"
#define MyAppPublisher "Faraz Automation"
...
AllowNoIcons=yes
LicenseFile=..\installer\ACTIVATION_NOTICE.txt
OutputDir=..\dist
...
begin
  ...
  begin
    MsgBox('Activation required on first run. Enter your license key to unlock MessageCannon Pro.', mbInformation, MB_OK);
  end;
end;
